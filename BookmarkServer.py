...
def CheckURI(uri, timeout=5):
    ...
    # (the following line) raise NotImplementedError("Step 1 isn't written yet.")
    try:
...
class Shortener(http.server.BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if name:
            if name in memory:
                ...
                # (the following line) raise NotImplementedError("Step 2 isn't written yet.")
    ...
    def do_POST(self):
        ...
        if "longuri" not in params or "shortname" not in params:
            ...
            #    Delete the following line.
            # (the following line) raise NotImplementedError("Step 3 isn't written yet!")
        ...
        if CheckURI(longuri):
            ...
            #    Delete the following line.
            # (the following line) raise NotImplementedError("Step 4 isn't written yet!")
            self.send_response(303)
            ...
            #    Delete the following line.
            # (the following line) raise NotImplementedError("Step 5 isn't written yet!")
            self.send_response(404)
            self.send_header('Content-type', 'text/plain; charset=utf-8')
            self.end_headers()
